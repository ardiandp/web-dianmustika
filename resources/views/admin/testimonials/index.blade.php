<x-layouts.admin title="Testimonial">
    ...
    <script>$(function () {
        var table = $('#datatable').DataTable({
            ...
            language: { search: 'Cari:', lengthMenu: 'Tampilkan _MENU_ data', info: 'Menampilkan _START_ - _END_ dari _TOTAL_ data', emptyTable: 'Belum ada testimonial.', zeroRecords: 'Data tidak ditemukan', paginate: { previous: '‹', next: '›' } },
        });
